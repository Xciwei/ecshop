...
/*添加店铺管理*/
$modules['03_shop']['04_shop_list']       = 'shop.php?act=list';  /*店铺管理*/
$modules['03_shop']['04_shop_user']       = 'shop.php?act=user';  /*店铺人员管理*/
$modules['03_shop']['04_shop_goods']       = 'shop.php?act=shop';  /*店铺商品管理*/


/*进销存管理*/
$modules['03_Invoicing']['01_Invoicing_purchase']       = 'purchase.php?act=index';  /*采购单*/
$modules['03_Invoicing']['02_Invoicing_arrival']       = 'arrival.php?act=index';  /*到货单*/
$modules['03_Invoicing']['03_Invoicing_storage']       = 'storage.php?act=index';  /*入库单*/
$modules['03_Invoicing']['04_Invoicing_out']       = 'out.php?act=index';  /*出库单*/
$modules['03_Invoicing']['05_Invoicing_transfer']       = 'transfer.php?act=index';  /*调拨单*/
$modules['03_Invoicing']['06_Invoicing_library']       = 'library.php?act=index';  /*盘库单*/
$modules['03_Invoicing']['07_Invoicing_profit_loss']       = 'profit_loss.php?act=index';  /*盈亏单*/
$modules['03_Invoicing']['08_Invoicing_sales']       = 'sales.php?act=index';  /*零售销货单*/
$modules['03_Invoicing']['09_Invoicing_return']       = 'return.php?act=index';  /*零售退货单*/
