...
<table cellpadding="3" cellspacing="1">
  <tr>
    <th>
      <input onclick='listTable.selectAll(this, "delivery_id")' type="checkbox" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?>/><a href="javascript:listTable.sort('delivery_sn', 'DESC'); "><?php echo $this->_var['lang']['label_delivery_sn']; ?></a><?php echo $this->_var['sort_delivery_sn']; ?>
    </th>
...
?>
  <tr>
    <td valign="top" nowrap="nowrap"><input type="checkbox" name="delivery_id[]" value="<?php echo $this->_var['delivery']['delivery_id']; ?>" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?> /><?php echo $this->_var['delivery']['delivery_sn']; ?></td>
