...
<table cellpadding="3" cellspacing="1">
  <tr>
    <th>
      <input onclick='listTable.selectAll(this, "back_id")' type="checkbox" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?>/><a href="javascript:listTable.sort('delivery_sn', 'DESC'); "><?php echo $this->_var['lang']['label_delivery_sn']; ?></a><?php echo $this->_var['sort_delivery_sn']; ?>
    </th>
...
?>
  <tr>
    <td valign="top" nowrap="nowrap"><input type="checkbox" name="back_id[]" value="<?php echo $this->_var['back']['back_id']; ?>" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?> /><?php echo $this->_var['back']['delivery_sn']; ?></td>
    ...
    <td align="center" valign="top"  nowrap="nowrap">
     ...
     <?php if (! $this->_var['node_info']): ?><a onclick="{if(confirm('<?php echo $this->_var['lang']['confirm_delete']; ?>')){return true;}return false;}" href="order.php?act=operate&remove_back=1&back_id=<?php echo $this->_var['back']['back_id']; ?>"><?php echo $this->_var['lang']['remove']; ?></a><?php endif; ?>
    </td>
  </tr>
