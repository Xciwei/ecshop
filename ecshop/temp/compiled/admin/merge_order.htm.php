...
<table cellspacing="1" cellpadding="3" width="100%">
  <?php if ($this->_var['node_info']): ?>
  <tr><td class="label" style="text-align:center">已经绑定了ERP,此功能不可用</td></tr>
  <?php else: ?>
  <tr>
    <td class="label"><a href="javascript:showNotice('noticeOrderSn');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.svg" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a><?php echo $this->_var['lang']['to_order_sn']; ?></td>

    <td><input name="to_order_sn" type="text" id="to_order_sn" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?>>
...
?>
  ...
  <tr>
    ...
    <td><input name="from_order_sn" type="text" id="from_order_sn" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?>>
...
?>
  ...
  <tr>
    <td colspan="2"><div align="center">
      <input name="merge" type="button" id="merge" value="<?php echo $this->_var['lang']['merge']; ?>" class="button" onclick="if (confirm(confirm_merge)) merge()" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?> />
    </div></td>
    </tr>
    <?php endif; ?>
</table>
