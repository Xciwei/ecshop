...
?>
        ...
        <tr>
          ...
          <td>
            <input type="text" name="start_time" maxlength="60" size="20" readonly="readonly" id="start_time_id" /><button name="start_time_btn" type="button" id="start_time_btn" onclick="return showCalendar('start_time_id', '%Y-%m-%d %H:%M', '24', false, 'start_time_btn');" class="cal"><img src="images/cal.png" alt=""></button>
            ~
            <input type="text" name="end_time" maxlength="60" size="20" readonly="readonly" id="end_time_id" /><button name="end_time_btn" type="button" id="end_time_btn" onclick="return showCalendar('end_time_id', '%Y-%m-%d %H:%M', '24', false, 'end_time_btn');" class="cal"><img src="images/cal.png" alt=""></button>
          </td>
        </tr>
        <tr>
    ...
    <div class="panel-ft">
      ...
      <input class="btn" name="query" type="submit" class="button" id="query" value="<?php echo $this->_var['lang']['button_search']; ?>" />
      <input class="btn btn-def" name="reset" type="reset" class='button' value='<?php echo $this->_var['lang']['button_reset']; ?>' />
