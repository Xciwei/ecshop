...
?>
    <tr>
      ...
      <td align="center">
        <a href="?act=detail&amp;id=<?php echo $this->_var['booking']['rec_id']; ?>" title="<?php echo $this->_var['lang']['detail']; ?>"><img src="images/icon_view.svg" border="0" height="16" width="16" /></a>
        <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['booking']['rec_id']; ?>,'<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><img src="images/icon_drop.svg" border="0" height="16" width="16" /></a>
      </td>
    </tr>
    <?php endforeach; else: ?>
