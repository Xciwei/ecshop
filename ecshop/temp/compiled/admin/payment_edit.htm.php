...
?>
  <tr>
    <td class="label">
      <?php if ($this->_var['config']['desc'] && $this->_var['pay']['pay_code'] != 'yunqi'): ?>
      <a href="javascript:showNotice('notice<?php echo $this->_var['config']['name']; ?>');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.svg" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a>
      <?php endif; ?>
      <span class="label"><?php echo $this->_var['config']['label']; ?>
    </td>
    <td>
      <!-- <?php if ($this->_var['config']['type'] == "text"): ?> -->
      <input name="cfg_value[]" type="<?php echo $this->_var['config']['type']; ?>" value="<?php echo $this->_var['config']['value']; ?>" size="40" /><br />
      <!-- <?php elseif ($this->_var['config']['type'] == "textarea"): ?> -->
      <textarea name="cfg_value[]" cols="80" rows="5"><?php echo $this->_var['config']['value']; ?></textarea><br />
      <!-- <?php elseif ($this->_var['config']['type'] == "select"): ?> -->
      <select name="cfg_value[]"><?php echo $this->html_options(array('options'=>$this->_var['config']['range'],'selected'=>$this->_var['config']['value'])); ?></select><br />
      <!-- <?php endif; ?> -->
      ...
      <span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="notice<?php echo $this->_var['config']['name']; ?>"><?php echo $this->_var['config']['desc']; ?></span>
      <?php endif; ?>
      <!--the tenpay code -->
