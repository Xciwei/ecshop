...
<div class="main-div" style="padding: 15px">
  <label><input type="radio" name="anonymous" value="1" checked  <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?>/> <?php echo $this->_var['lang']['anonymous']; ?></label><br />
  <label><input type="radio" name="anonymous" value="0" id="user_useridname" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?>/> <?php echo $this->_var['lang']['by_useridname']; ?></label>
  <input name="keyword" type="text" value=""  <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?>/>
  <input type="button" class="button" name="search" value="<?php echo $this->_var['lang']['button_search']; ?>" onclick="searchUser();" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?> />
  <select name="user" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?>></select>
  <p><?php echo $this->_var['lang']['notice_user']; ?></p>
</div>
<div style="text-align:center">
  <p>
    <input name="submit" type="submit" class="button" value="<?php echo $this->_var['lang']['button_next']; ?>"  <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?>/>
