...
<div class="form-div">
  <form action="" method="post" id="selectForm" name="selectForm">
    ...
    <input type="text" name="start_date" value="<?php echo $this->_var['start_date']; ?>" size="12" readonly onclick="return showCalendar(this, '%Y-%m-%d', false, false, this);">&nbsp;&nbsp;
    <?php echo $this->_var['lang']['end_date']; ?>:
    <input type="text" name="end_date" value="<?php echo $this->_var['end_date']; ?>" size="12" readonly onclick="return showCalendar(this, '%Y-%m-%d', false, false, this);">
    ...
    <!--<?php $_from = $this->_var['start_date_arr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'start_date_0_31079400_1538013685');if (count($_from)):
    foreach ($_from AS $this->_var['k'] => $this->_var['start_date_0_31079400_1538013685']):
?>-->
    <?php if ($this->_var['k'] > 0): ?>
    &nbsp;+&nbsp;
    <?php endif; ?>
    <input type="text" name="year_month[]" value="<?php echo $this->_var['start_date_0_31079400_1538013685']; ?>" style="width:60px;" onclick="return showCalendar(this, '%Y-%m', false, false, this);" />
