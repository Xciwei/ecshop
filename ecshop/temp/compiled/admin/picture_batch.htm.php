...
<form action="picture_batch.php" method="post" name="theForm" onsubmit="return start()">
  ...
  <tr>
    <td ><select name="cat_id" onchange="goods_list(this);"><option value="0"><?php echo $this->_var['lang']['all_category']; ?></caption><?php echo $this->_var['cat_list']; ?></select>
...
function add_search_goods(obj)
{
    ...
    goods_div.innerHTML = '<input type="hidden" name="multi_goods_id[]" value="' + goods_id + '">' + goods_name + '&nbsp;&nbsp;<img style="cursor: pointer;" onclick="del_search_goods(\'' + 'goods_' + goods_id + '\');" src="images/no.svg" width="20">';
